...
export function DinnerComposition() {
  ...
  return (
    ...
    >
      ...
      {/* 2. Layered Stage: Colossal Display Heading BEHIND Dining Photo Plate with subtle ~20% overlap */}
      <div className="relative w-full px-6 sm:px-10 lg:px-14 mt-4">
        <div className="relative w-full">
          ...
          <div className="relative lg:absolute top-0 left-0 w-full z-0 pointer-events-none select-none">
            <h2
              ref={wordmarkRef}
              className="font-serif text-[12.5vw] sm:text-[12vw] lg:text-[11vw] text-[#0A2540] leading-[0.8] tracking-[-0.04em] uppercase"
            >
              DINNER, WITH NO WALLS.
            </h2>
          </div>

          {/* Main Dining Photo Plate Overlapping in Front (z-10) with subtle ~20% overlap */}
          <div className="relative w-full lg:w-[86%] lg:ml-auto pt-[4.5vw] sm:pt-[5.5vw] lg:pt-[6.5vw] z-10">
            <div
              ref={dinnerPhotoRef}
